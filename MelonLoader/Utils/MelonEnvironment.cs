...
namespace MelonLoader.Utils
{
    public static class MelonEnvironment
    {
        ...
        public static string ModsDirectory => Path.Combine(MelonBaseDirectory, "F1");
        public static string PluginsDirectory => Path.Combine(MelonBaseDirectory, "F2");
        public static string UserLibsDirectory => Path.Combine(MelonBaseDirectory, "F3");
        public static string UserDataDirectory => Path.Combine(MelonBaseDirectory, "F4");
